package com.alphaboom.guideforupwork.subscription;
...
public class SubsManeger extends AppCompatActivity implements PurchasesUpdatedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_subs_maneger);
                        ...
                        if (billingResult.getResponseCode() == BillingClient.BillingResponseCode.OK) {
                            if (skuDetailsList != null && skuDetailsList.size() > 0) {
                                BillingFlowParams flowParams = BillingFlowParams.newBuilder()
                                        ...
                                        .build();
                                billingClient.launchBillingFlow(SubsManeger.this, flowParams);
                            }
                            else{
